...
public class Sistema {
    ...
    // Metodo para o sistema administrativo
        ...
        while(ligado){
            ...
            switch(opt){
                ...
                case 2:
                    ...
                    adm.removerFilme(nomeRemove); // Chama o metodo de remoção de filme
                    break;
                ...
                case 3:
                    ...
                    adm.alugarFilme(nomeAlugar); // Chama o metodo de aluguel de filme
                    break;
                ...
                case 4:
                    ...
                    adm.devolverFilme(nomeDevolv); // Chama o metodo de devolução de filme
                    break;

                case 5:
                    // Mostrar todos os filmes disponíveis no catálogo
                    adm.mostrarFilmes(); // Chama o metodo para exibir filmes
                    break;

                case 6:
                    // Procurar filme específico no catálogo
                    adm.procurarFilme(); // Chama o metodo de busca de filme
                    break;

                case 7:
                    // Alterar dados de um filme
                    adm.alterarFilme(); // Chama o metodo para alterar informações de um filme
                    break;
                ...
                case 9:
                    Login log = new Login();
                    log.mostrarUsuarios(); // mostra os usuarios que foram cadastrados no sistema
                    break;
    ...
    // Metodo para o sistema de usuário
        ...
        while(ligado){
            ...
            switch(opt){
                case 1:
                    ...
                    loc.alugarFilme(nomeAlug); // Chama o metodo de aluguel de filme
                    break;
                ...
                case 2:
                    ...
                    System.out.println("Digite o nome do filme que deseja devolver: ");
                    String nomeDevolv = inp.nextLine();
                    loc.devolverFilme(nomeDevolv); // Chama o metodo de devolução de filme
                    break;
                ...
                case 4:
                    ...
                    loc.procurarFilme(); // Chama o metodo de busca de filme
                    break;
